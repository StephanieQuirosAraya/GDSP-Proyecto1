...
CREATE TABLE IF NOT EXISTS `Food_services`.`PermissionsPerRole` (
  ...
  `Roles_RoleID` TINYINT NOT NULL,
  `PermissionID` SMALLINT NOT NULL,
  INDEX `fk_PermissionsPerRole_Permissions1_idx` (`PermissionID` ASC) VISIBLE,
  INDEX `fk_PermissionsPerRole_Roles1_idx` (`Roles_RoleID` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `Food_services`.`CommerceTypes` (
  `CommerceTypesID` TINYINT NOT NULL,
  `Name` NVARCHAR(50) NOT NULL,
  `Description` NVARCHAR(200) NOT NULL,
  `PriorityNumber` TINYINT NOT NULL,
  PRIMARY KEY (`CommerceTypesID`))
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `Food_services`.`Commerces` (
  ...
  INDEX `fk_Commerces_CommerceTypes1_idx` (`CommerceTypesID` ASC) VISIBLE,
  ...
  CONSTRAINT `fk_Commerces_CommerceTypes1`
    FOREIGN KEY (`CommerceTypesID`)
    REFERENCES `Food_services`.`CommerceTypes` (`CommerceTypesID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
CREATE TABLE IF NOT EXISTS `Food_services`.`BusinessHours` (
  `BusinessHourID` BIGINT NOT NULL,
...
CREATE TABLE IF NOT EXISTS `Food_services`.`CharacteristicOptions` (
  `CharacteristicOptionsID` TINYINT NOT NULL,
  `Name` NVARCHAR(50) NOT NULL,
  `ExtraPrice` INT NULL,
  `CharacteristicID` INT NOT NULL,
  PRIMARY KEY (`CharacteristicOptionsID`),
...
CREATE TABLE IF NOT EXISTS `Food_services`.`CharacteristicsPerProduct` (
  `CharacteristicPerProductID` INT NOT NULL,
...
CREATE TABLE IF NOT EXISTS `Food_services`.`UserChoices` (
  ...
  INDEX `fk_UserChoices_CharacteristicOptions1_idx` (`CharacteristicOptionsID` ASC) VISIBLE,
  ...
  CONSTRAINT `fk_UserChoices_CharacteristicOptions1`
    FOREIGN KEY (`CharacteristicOptionsID`)
    REFERENCES `Food_services`.`CharacteristicOptions` (`CharacteristicOptionsID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
